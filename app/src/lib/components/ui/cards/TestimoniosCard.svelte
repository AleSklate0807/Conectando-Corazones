...
>
	...
	<blockquote
		class="relative mb-6 grow text-center text-base leading-relaxed text-gray-700/90 italic selection:bg-blue-50 selection:text-blue-800"
	>
