...
<div
	class="group flex h-full flex-col overflow-hidden rounded-xl border border-gray-100 bg-white shadow-sm transition-all duration-300 hover:shadow-md"
...
>
	...
	<!-- Justificación de rechazo (Modal) - Fuera del árbol principal del card -->
	<Modal
